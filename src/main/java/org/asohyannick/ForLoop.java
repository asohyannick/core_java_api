...
public static void main ( String[] args ) {
	...
	int totalRecords = 95;
	int pageSize = 10;
	int totalPages = ( int ) java.lang.Math.ceil ( ( double ) totalRecords / pageSize );
	System.out.println ( "\nPagination:" );
	for ( int page = 1 ; page <= totalPages ; page++ ) {
		int offset = ( page - 1 ) * pageSize;
		int limit = java.lang.Math.min ( pageSize , totalRecords - offset );
	...
	for ( int retry = 0 ; retry < maxRetries ; retry++ ) {
		long waitMs = ( long ) java.lang.Math.pow ( 2 , retry ) * 100; // 100, 200, 400, 800, 1600ms
